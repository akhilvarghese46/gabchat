...
class AddContactAdapter(private val addContactClickedListener: AddContactClickedListener, private val mList: List<ChannelModel>) : RecyclerView.Adapter<AddContactAdapter.ViewHolder>() {
